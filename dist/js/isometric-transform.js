...
// --- Configuration ---
const HALF_TILE_WIDTH = 0.5 * constants_1.TILE_WIDTH;
const HALF_TILE_HEIGHT = 0.5 * constants_1.TILE_HEIGHT;
...
function screenToWorld(screenPos) {
    ...
    const worldZ = isoMatrix.zToScreenZ === 0 ? 0 : screenPos.z / isoMatrix.zToScreenZ;
    return {
        x: Math.round(worldX),
        y: Math.round(worldY),
        z: Math.round(worldZ),
