...
const isometric_transform_1 = require("./isometric-transform");
class Player {
    #pixelHitbox;
    #gridHitbox;
    #chunkPosition;
    ...
    set pixelPosition(position) {
        ...
        this.gridPosition = (0, isometric_transform_1.screenToWorld)(this.pixelHitbox);
        this.#chunkPosition = {
    ...
    update() {
        ...
        if (this.gridHitbox.z < constants.VOID_DEPTH)
            this.health -= 2;
    }
